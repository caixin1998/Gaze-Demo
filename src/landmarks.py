...
hr_path = 'src/ext/HRNet-Facial-Landmark-Detection'
sys.path.append(hr_path)
...
class landmarks:
    ...
    def __init__(self, config=config):
        ...
        config.defrost()
        config.merge_from_file(hr_path + "/experiments/wflw/face_alignment_wflw_hrnet_w18.yaml")
        config.freeze()
        ...
        state_dict = torch.load(hr_path + "/hrnetv2_pretrained/HR18-WFLW.pth")
